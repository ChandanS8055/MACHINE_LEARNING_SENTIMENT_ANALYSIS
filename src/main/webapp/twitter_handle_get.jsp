				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
						<li ><a data-toggle="tab" href="#Home">
								Welcome</a></li>
						<li class="active"><a data-toggle="tab" href="#handles"> Twitter
								Handles</a></li>
						<li><a data-toggle="tab" href="#keywords"> Twitter
								HashTags</a></li>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									<div class="breadcomb-ctn">
										...
										<p>Here, you can view the list of all the Handles you have added. You can delete any of them in case you don't need them to be analyzed.</p>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="form-element-list">
						<div class="row" style='min-height: 400px;'>
							...
							<%
								List<TwitterHandle> handles = (List<TwitterHandle>) request.getAttribute("handles");
								if (handles == null || handles.size() == 0)
								{
								   %>
								   		<h5>The Twitter Handles added by you will appear here</h5>
								   <%
								}
								else
								{
								   			...
								   			for (TwitterHandle th: handles)
								   			{
								   			   %>
														  ...
														  <div class="panel-body">
														    ...
														    <br/>
														    <br/>
														    Added at <b><%=sdf.format(th.getEntry_time()) %></b>
														  </div>
														  <div class="panel-footer"><a href='twitterhandle?requestType=delete&handle=<%=th.getHandle()%>'>Delete</a></div>
														</div>
								   			   		</div>
								   			   <%
								   			}
