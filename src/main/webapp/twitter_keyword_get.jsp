<!doctype html>
<%@page import="com.sentimentanalysis.pojo.TwitterKeyword"%>
<%@page import="java.text.SimpleDateFormat"%>
<%@page import="com.sentimentanalysis.pojo.TwitterHandle"%>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
						<li ><a data-toggle="tab" href="#Home">
								Welcome</a></li>
						<li ><a data-toggle="tab" href="#handles"> Twitter
								Handles</a></li>
						<li class="active"><a data-toggle="tab" href="#keywords"> Twitter
								HashTags</a></li>
						<li><a data-toggle="tab" href="#analysis"> Analysis</a></li>
						<li><a data-toggle="tab" href="#mailbox"> <%=u1.getFname()%>
								<%=u1.getLname()%></a></li>
					</ul>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									<div class="breadcomb-ctn">
										<h2>Twitter Keywords</h2>
										<p>Here, you can view the list of all the Keywords you have added. You can delete any of them in case you don't need them to be analyzed.</p>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="form-element-list">
						<div class="row" style='min-height: 400px;'>
							...
							<%
								List<TwitterKeyword> keywords = (List<TwitterKeyword>) request.getAttribute("keywords");
								if (keywords == null || keywords.size() == 0)
								{
								   %>
								   		<h5>The Tweets Keywords added by you will appear here</h5>
								   <%
								}
								else
								{
								   %>
								   		<%
								   			...
								   			for (TwitterKeyword tk: keywords)
								   			{
								   			   %>
								   			   		<div class='col-md-3'>
														  ...
														  <div class="panel-body">
														    ...
														    <br/>
														    <br/>
														    Added at <b><%=sdf.format(tk.getEntry_time()) %></b>
														  </div>
														  <div class="panel-footer"><a href='twitterkeyword?requestType=delete&keyword=<%=tk.getKeyword()%>'>Delete</a></div>
														</div>
								   			   		</div>
								   			   <%
								   			}
