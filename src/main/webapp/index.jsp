...
<body>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="header-top-menu">
                        <h4 style='float:right; color: white; padding-top:20px;'>EWCM Institutions</h4>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul class="mobile-menu-nav">  
                                ...
                                <li><a data-toggle="collapse" data-target="#demoevent" href="#">Access</a>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li><a data-toggle="tab" href="#mailbox"> Access</a>
                        </li>
                    </ul>
                    <div class="tab-content custom-menu-content">
                        <div id="Home" class="tab-pane in active notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="index.jsp">About</a>
                                </li>
                                </li>
                            </ul>
                        </div>
    ...
    <img src="">
    <!-- Start Status area -->
    <div class="notika-status-area" style='min-height:600px;'>
        <div class="container">
            <div class="row">
