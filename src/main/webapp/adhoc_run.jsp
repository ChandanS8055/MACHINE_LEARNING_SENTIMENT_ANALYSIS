							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									<div class="breadcomb-ctn">
										<h2>Ad-Hoc Run</h2>
										<p>Here, you can analyze the sentiment of any given input string on the fly.</p>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="form-element-list">
						<div class="row" style='min-height:400px;'>
							...
							<%
								Map<String, VScore> result = (Map<String, VScore>) request.getAttribute("result");
							...
							<form action='adhocrun' method=post class='col-md-6'>
								<label>Enter the sentence to be analyzed.</label>
								<textarea rows="5" class='form-control' name='sentence' placeholder="Minimum 50 characters" required></textarea>
								<br/>
								<button class="btn btn-success" type="submit">Analyze sentence</button>
