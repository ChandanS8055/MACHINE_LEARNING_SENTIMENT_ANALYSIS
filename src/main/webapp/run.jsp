							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
								<div class="breadcomb-wp">
									<div class="breadcomb-ctn">
										<h2>Run</h2>
										<p>Here, you can run the Twitter Sentiment Analysis Algorithm.</p>
									</div>
								</div>
							</div>
						</div>
							...
							<%
								...
								if (check != null && check.equals("yes"))
								{
								   %>
								   		...
								   		<h4>The Algorithm is currently RUNNING. You cannot re-execute it until it finishes the current run. </h4>
								   		<br/>
								   		<br/>
								...
								{
								   %>
								   								<form action='run' class='col-md-6' >
																	<button type="submit" class='btn btn-success'>Run the Algorithm</button>
																</form>
																<br/><br/><br/>
																<br/>
